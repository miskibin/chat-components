...
export const docsNav: DocsNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      component("render-error-boundary", "Render Error Boundary"),
      component("change-summary", "Change Summary"),
      component("file-preview", "File Preview"),
      component("diff-view", "Diff View"),
      component("file-tree", "File Tree"),
  ...
  },
  {
    ...
    items: [
      ...
      component("sidebar-resize-rail", "Sidebar Resize Rail"),
    ],
  },
  {
    title: "Hooks",
